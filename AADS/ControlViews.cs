...
namespace AADS
{
    public class ControlViews
    {
        ...
        private Views.Marker.FireUnitView fireUnitView = new Views.Marker.FireUnitView();
        ...
        private Views.Marker.FixedPointView fixedPointView = new Views.Marker.FixedPointView();
        ...
        public static Views.Marker.FireUnitView FireUnitView
        {
            get => Instance.fireUnitView;
        }
        ...
        public static Views.Marker.FixedPointView FixedPointView
        {
            get => Instance.fixedPointView;
        }
        ...
        public ControlViews()
        {
            ...
            Main.gMap.MouseClick += cityView.GMap_MouseClick;
            // Track
